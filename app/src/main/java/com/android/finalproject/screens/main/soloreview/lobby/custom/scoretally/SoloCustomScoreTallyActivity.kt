...
class SoloCustomScoreTallyActivity : AppCompatActivity(), SoloCustomScoreTallyContract.View {
    private lateinit var presenter: SoloCustomScoreTallyPresenter
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = SoloCustomScoreTallyPresenter(this)
