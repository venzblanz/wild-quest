...
import com.android.finalproject.screens.main.groupreview.lobby.competitive.room.GroupCompeRoomActivity
import com.android.finalproject.screens.main.groupreview.lobby.custom.prep.GroupCustomPrepActivity
...
class GroupReviewActivity : AppCompatActivity(), GroupReviewContract.View {
    private lateinit var presenter: GroupReviewPresenter
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = GroupReviewPresenter(this, GroupReviewModel(application as WildQuestApp))
    ...
    override fun navigateToCompetitiveRoom(){
        loadScreen(this,GroupCompeRoomActivity::class.java)
    }
    override fun navigateToCustomRoom(){
        start(GroupCustomPrepActivity::class.java)
    }
