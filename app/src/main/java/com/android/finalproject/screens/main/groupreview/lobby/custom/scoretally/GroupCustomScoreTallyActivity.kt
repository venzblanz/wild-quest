...
class GroupCustomScoreTallyActivity : AppCompatActivity(), GroupCustomScoreTallyContract.View {
    private lateinit var presenter: GroupCustomScoreTallyPresenter
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = GroupCustomScoreTallyPresenter(this)
